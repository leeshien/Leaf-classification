...
# number of images to retrieve - can be changed to compute the MAP@nRetrieved
nRetrieved = 50
...
retrievedCats = np.uint8(np.floor((nearest_idx[1:nRetrieved+1])/50));    # BUG FIX 2: nearest_idx[1:nRetrieved+1])/100 --> nearest_idx[1:nRetrieved+1])/50
print(retrievedCats)
